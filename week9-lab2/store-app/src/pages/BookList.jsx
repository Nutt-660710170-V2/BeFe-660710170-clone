...
const BookList = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-sky-200 to-green-200">
            ...
            <div className="bg-gradient-to-r from-viridian-600 to-green-600 text-white p-6">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="bg-green text-viridian-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
                >
                  ➕ เพิ่มหนังสือใหม่
                </button>
              </div>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex justify-center gap-2">
                            <button
                              ...
                              className="px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-viridian-700 transition-colors text-sm font-medium"
                            >
                              ✏️ แก้ไข
                            </button>
                            <button
