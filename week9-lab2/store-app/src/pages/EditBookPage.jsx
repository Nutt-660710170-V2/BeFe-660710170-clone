...
const EditBookPage = () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-viridian-600 to-green-700 flex items-center justify-center py-12 px-4">
        <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full text-center">
          ...
          <button 
            ...
            className="px-6 py-3 bg-viridian-600 text-black rounded-lg hover:bg-viridian-700 transition-colors font-semibold"
          >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-sky-200 to-green-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        {/* Header */}
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-viridian-600 to-green-600 text-black p-8 text-center">
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-4 pt-6 border-t border-gray-200">
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto px-6 py-3 bg-gradient-to-r from-sky-400 to-green-200 text-black rounded-lg hover:from-viridian-700 hover:to-green-700 transition-all shadow-lg font-semibold"
                >
                  💾 บันทึกการแก้ไข
                </button>
              </div>
