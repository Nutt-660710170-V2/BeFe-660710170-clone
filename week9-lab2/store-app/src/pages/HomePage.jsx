...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-sky-400 to-green-200 text-black">
      ...
      <section className="py-16 bg-viridian-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-Black-200 mb-8">
          ...
          <form className="max-w-md mx-auto flex flex-col sm:flex-row gap-4">
            ...
            />
            <button type="submit" className="px-8 py-3 bg-yellow-400 text-Black-900
