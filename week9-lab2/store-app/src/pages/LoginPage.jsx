...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-sky-400 to-green-200 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center py-3 px-4 border border-transparent
                  rounded-lg shadow-sm text-sm font-medium text-black bg-gradient-to-r from-sky-400 to-green-200 
